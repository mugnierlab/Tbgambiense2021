...
plotdata <- read_csv(file = "FigureData/TbgHighlyExpressed.csv")
...
Fig1B <- plotdata %>% 
  select(patient_number, location, cluster, nterm_typesubtype) %>% 
  distinct() 
...
upsetList <- list(
  patient1 = unique(as.character(plotdata$cluster[plotdata$patient_number =="1"])),
  patient2 = unique(as.character(plotdata$cluster[plotdata$patient_number =="2"])),
  patient3 = unique(as.character(plotdata$cluster[plotdata$patient_number =="3"])),
  patient11 = unique(as.character(plotdata$cluster[plotdata$patient_number =="11"])),
  patient12 = unique(as.character(plotdata$cluster[plotdata$patient_number =="12"])),
  patient13 = unique(as.character(plotdata$cluster[plotdata$patient_number =="13"])),
  patient17 = unique(as.character(plotdata$cluster[plotdata$patient_number =="17"])),
  patient19 = unique(as.character(plotdata$cluster[plotdata$patient_number =="19"])),
  patient23 = unique(as.character(plotdata$cluster[plotdata$patient_number =="23"])),
  patient29 = unique(as.character(plotdata$cluster[plotdata$patient_number =="29"])),
  patient30 = unique(as.character(plotdata$cluster[plotdata$patient_number =="30"])),
  patient33 = unique(as.character(plotdata$cluster[plotdata$patient_number =="33"])))
...
gambCorr <- plotdata %>% select("patient_number", "cluster") %>% distinct() %>% group_by(patient_number) %>% summarise(totalVSG = n()) %>% merge(SL_Ct, .)
gambCorr
...
typeCorr <- plotdata %>% select("patient_number", "cluster", "nterm_typesubtype") %>% distinct() %>% 
